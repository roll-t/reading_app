...
class EndPointSetting {
  ...
  static String getNovelByIdEnpoint ({required String id})=> "${_baseUrl}book-data/$id"; 

  // chapter endpoint
  static String getListChapterOfBookEndpoint ({required String slug})=> "${_baseUrl}chapter/book/$slug";
