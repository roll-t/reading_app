...
class AppContents {
  ...
  static const String subVerification = 'We have send a code to your email';
  static const String code ="Code";
  static const String resendIn ="Resend In";
  static const String sec ="sec";
  static const String checkEmailForVerifiaction = "Check email for authentication";
  static const String subCheckEmailForVerifiaction ="Please check your email for a verification link. If you don\'t see it, check your spam folder.";
  ...
  static const String comic = "Truyện Tranh";
  static const String audioStory = "Truyện audio";
  static const String bookCase = "Tủ sách";
  ...
  // category 
  static const String rank ="Bảng xếp hạng";
  static const String shortStory ="Truyện ngắn";
  static const String gold ="Phúc lợi";
  static const String selection ="Truyện Chọn lọc";


  //title list
  static const String titleListContinue ="Đọc tiếp";
  static const String btvRecomment ="BTV đề cử";
  static const String seeMore ="Xem thêm";
  static const String newestUpdate= "Mới cập nhật";
  static const String justPosted= "Mới đăng";
