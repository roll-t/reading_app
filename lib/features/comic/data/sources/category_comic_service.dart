...
import 'package:reading_app/features/comic/domain/usecases/category/categories_usecase.dart';
...
class CategoryComicService extends ApiService {
  ...
  Future<void> setCategoryCache() async {
    ...
    final response = await dioConfig.dio.get(APIEndpoint.categoriesEndpoint());
    final apiResponse = response.data;
