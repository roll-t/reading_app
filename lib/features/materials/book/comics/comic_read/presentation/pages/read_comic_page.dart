...
import 'package:reading_app/features/materials/book/comic/comic_read/presentation/controllers/read_comic_controller.dart';
        ...
        onWillPop: () async {
          Get.back(
              result: ReadingComicBookCaseModel(
                  ...
                  chapterName:controller.currentChapterArguments.value["chapter_name"],
                  chapterApiData: controller
                      // ignore: invalid_use_of_protected_member
                      .currentChapterArguments.value["chapter_api_data"],
