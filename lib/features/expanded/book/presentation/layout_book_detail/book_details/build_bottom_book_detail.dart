...
class BuildBottomNavBookDetail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.symmetric( vertical: SpaceDimens.space5,horizontal: SpaceDimens.spaceStandard),
      child: Row(
        ...
        Wrap(
          ...
          Container(
            ...
            decoration: BoxDecoration(border: Border.all(width: 1,color: AppColors.gray3),borderRadius: BorderRadius.circular(RadiusDimens.radiusFull)),
        ...
        Expanded(
          child: InkWell(
            onTap: (){Get.toNamed(Routes.readBook);},
            child: Container(
              ...
              height: 50,
              child: const Center(child: TextLargeBold(textChild: AppContents.readNow,)),
            ),
          ),
        )
      ],),
