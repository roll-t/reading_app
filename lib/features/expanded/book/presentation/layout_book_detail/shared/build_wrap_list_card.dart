...
class BuildWrapListCard extends StatelessWidget {
  ...
  final List<dynamic> listBookData;
  final Widget Function(double widthCard, dynamic bookModel)
      cardBuilder; // Thay đổi ở đây
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: TextLargeBold(textChild: titleList!),
                ),
                if (seeMore != null)
                  Padding(
                    padding: const EdgeInsets.only(
