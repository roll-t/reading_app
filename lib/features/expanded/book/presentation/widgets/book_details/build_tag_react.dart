  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: const EdgeInsets.symmetric(
          horizontal: SpaceDimens.spaceStandard, vertical: SpaceDimens.space20),
      child: Row(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child: const TextMediumSemiBold(textChild: AppContents.send,colorChild: AppColors.accentColor,)
              ),
            ],
          ),
        );
