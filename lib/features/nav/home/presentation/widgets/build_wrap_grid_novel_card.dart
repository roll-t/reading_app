...
class BuildWrapGridNovelCard extends StatelessWidget {
  final double heightCardItem;
  final String? title;
  final VoidCallback? seeMore;
  final Widget Function(double heightImage, NovelResponse bookModel) cardChild;
  final int columns;
