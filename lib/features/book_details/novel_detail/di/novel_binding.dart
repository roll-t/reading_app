...
import 'package:reading_app/features/book_details/novel_detail/data/repositories/novel_detail_repository_impl.dart';
import 'package:reading_app/features/book_details/novel_detail/domain/repositories/novel_detail_repository.dart';
import 'package:reading_app/features/book_details/novel_detail/domain/usecase/fetch_all_category_usecase.dart';
import 'package:reading_app/features/book_details/novel_detail/domain/usecase/fetch_all_comment_of_novel_usecase.dart';
import 'package:reading_app/features/book_details/novel_detail/domain/usecase/fetch_chapters_of_novel_usecase.dart';
import 'package:reading_app/features/book_details/novel_detail/domain/usecase/fetch_novel_by_id_usecase.dart';
import 'package:reading_app/features/book_details/novel_detail/presentation/controller/novel_detail_controller.dart';
import 'package:reading_app/features/book_details/novel_detail/presentation/controller/read_novel_cotroller.dart';
